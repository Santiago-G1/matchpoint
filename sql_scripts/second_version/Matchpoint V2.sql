...
CREATE TABLE Historial_promociones (
	...
	nivel_anterior NVARCHAR (50),
	nivel_actual NVARCHAR (50),
	fecha DATE,
	motivos NVARCHAR (100) NULL,

	CONSTRAINT fk_Historial_promociones_id_tenista FOREIGN KEY (id_tenista)
		REFERENCES Tenistas (id_persona)
);
...
CREATE TABLE Sesiones (
	...
	id_entrenador INT,
	fue_cancelada BIT,
	motivo_cancelación NVARCHAR (100) NULL,
	tema_trabajado NVARCHAR (100),

	CONSTRAINT fk_Sesiones_id_cancha FOREIGN KEY (id_cancha)
		REFERENCES Canchas(id_cancha),
	CONSTRAINT fk_Sesiones_id_entrenador FOREIGN KEY (id_entrenador)
		REFERENCES Entrenadores(id_persona),
	CONSTRAINT chk_Sesiones_motivo_cancelación CHECK (
		(fue_cancelada = 0 AND motivo_cancelación IS NULL) 
		 OR 
		(fue_cancelada = 1 AND motivo_cancelación IS NOT NULL))
);
...
CREATE TABLE Asistencias (
	...
	motivo_inasistencia NVARCHAR (100) NULL,
	observaciones NVARCHAR(100) NULL,

	CONSTRAINT fk_Asistencias_id_tenista FOREIGN KEY (id_tenista)
		REFERENCES Tenistas(id_persona),
	CONSTRAINT fk_Asistencias_id_sesión FOREIGN KEY (id_sesión)
...
CREATE TABLE Evaluaciones (
	...
	CONSTRAINT fk_Evaluaciones_id_tenista FOREIGN KEY (id_tenista)
		REFERENCES Tenistas (id_persona),
		CONSTRAINT fk_Evaluaciones_id_sesión FOREIGN KEY (id_sesión)
		REFERENCES Sesiones (id_sesión),
);

GO
CREATE TABLE Tipos_componentes_evaluados (
	id_tipo_componente INT PRIMARY KEY,
	nombre NVARCHAR (30),

	CONSTRAINT uq_Tipos_componentes_evaluados_nombre UNIQUE (nombre)
);

GO
CREATE TABLE Componentes_evaluados (
	id_componente_evaluado INT PRIMARY KEY,
	nombre NVARCHAR (30),
	calificación INT,
	comentarios NVARCHAR (100) NULL,
	id_tipo_componente_evaluado INT,

	CONSTRAINT fk_Componentes_evaluados_id_tipo_componente_evaluado 
		FOREIGN KEY (id_tipo_componente_evaluado)
		REFERENCES Tipos_componentes_evaluados(id_tipo_componente)
);

GO
CREATE TABLE Se_evaluó (
	id_evaluación INT,
	id_componente_evaluado INT,

	CONSTRAINT pk_Se_evaluó PRIMARY KEY (id_evalucación,id_componente_evaluado),
	CONSTRAINT fk_Se_evaluó_id_evaluación FOREIGN KEY (id_evaluación)
		REFERENCES Evaluaciones (id_evaluación),
	CONSTRAINT fk_Se_evaluó_id_componente_evaluado FOREIGN KEY (id_componente_evaluado)
		REFERENCES Componentes_evaluados (id_componente_evaluado)
);
...
CREATE TABLE Torneos (
	...
	fecha_inicio DATE,
	fecha_fin DATE,
	tipo_superficie NVARCHAR (50),
	nivel_competitivo NVARCHAR (50),
	id_ciudad INT,
	id_organizador INT,

	CONSTRAINT fk_Torneos_id_ciudad FOREIGN KEY (id_ciudad)
		REFERENCES Ciudades (id_ciudad),
	CONSTRAINT fk_Torneos_id_organizador FOREIGN KEY (id_organizador)
...
CREATE TABLE Categorías (
	...
	CONSTRAINT uq_CategorÍas_nombre UNIQUE (nombre)
);

GO
CREATE TABLE Torneos_categorías (
	id_categoría INT,
	id_torneo INT,

	CONSTRAINT pk_Torneos_categorías PRIMARY KEY (id_categoría,id_torneo),
	CONSTRAINT fk_Torneos_categorías_id_categoría FOREIGN KEY (id_categoría)
		REFERENCES Categorías (id_categoría),
	CONSTRAINT fk_Torneos_categorías_id_torneo FOREIGN KEY (id_torneo)
...
CREATE TABLE Modalidades (
	...
	CONSTRAINT Modalidades_nombre UNIQUE (nombre)
);

GO
CREATE TABLE Torneos_modalidades (
	id_modalidad INT,
	id_torneo INT,

	CONSTRAINT pk_Torneos_modalidades PRIMARY KEY (id_modalidad,id_torneo),
	CONSTRAINT fk_Torneos_modalidades_id_modalidad FOREIGN KEY (id_modalidad)
		REFERENCES Modalidades (id_modalidad),
	CONSTRAINT fk_Torneos_modalidades_id_torneo FOREIGN KEY (id_torneo)
		REFERENCES Torneos (id_torneo)
);
...
CREATE TABLE Participantes (
	...
	id_torneo INT,
	fecha_participación DATE,

	CONSTRAINT fk_Participantes_id_torneo FOREIGN KEY (id_torneo)
		REFERENCES Torneos (id_torneo)
);

GO
CREATE TABLE Participantes_inscritos (
	id_participante INT,
	id_tenista INT,

	CONSTRAINT pk_Participantes_inscritos PRIMARY KEY (id_participante, id_tenista),
	CONSTRAINT fk_Participantes_inscritos_id_participante FOREIGN KEY (id_participante)
		REFERENCES Participantes (id_participante),
	CONSTRAINT fk_Participantes_inscritos_id_tenista FOREIGN KEY (id_tenista)
		REFERENCES Tenistas (id_persona)
);
...
CREATE TABLE Resultados (
	...
	CONSTRAINT fk_Resultados_id_torneo FOREIGN KEY (id_torneo)
		REFERENCES Torneos (id_torneo),
	CONSTRAINT fk_Resultados_id_participante FOREIGN KEY (id_participante)
		REFERENCES Participantes (id_participante)
);